                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <!--   *******************    ******************    -->
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">user_key</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="user_key" id="email_address_2" class="form-control" placeholder="4f6158ef97874d8d49ead880fc6fe756">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!--   *******************    ******************    -->
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="type" id="email_address_2" class="form-control" placeholder="'ModifiableStopLoss  /  Simple ">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Limit</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="limit" id="email_address_2" class="form-control" placeholder="Enter your Limit">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Stop</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="stop" id="email_address_2" class="form-control" placeholder="Enter your Stop">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <p>
                                ...
                                if ($resultats["OrderStatus"] == "Executed") {
